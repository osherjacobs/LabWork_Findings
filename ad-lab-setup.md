...
| Workstation ISO | Windows 10 or 11 Evaluation (free from Microsoft) |
...
| WS01 | Windows 10/11 | 4GB | 60GB | 192.168.56.20 |
| Kali | Kali Linux | 4GB | 80GB | 192.168.56.30 |

Set all VMs to **Host-Only** network adapter (same subnet, no internet required).
...
Environment is ready for domain attack practice.
