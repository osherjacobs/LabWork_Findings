...
**A note on rule tampering:** Detection rules are alerting logic layered on top of immutable indexed telemetry. Tampering with rules requires separate access to the SIEM platform — a separate credential set, separate authentication, and separate network segment outside the scope of this threat model. In a production environment, the SIEM is off-premises and inaccessible to a compromised DC admin. The underlying event data persists in the index regardless of rule state. In this lab, the SIEM runs locally — that boundary does not exist here, and we acknowledge it.
...
<img width="1867" height="931" alt="image" src="https://github.com/user-attachments/assets/afce3017-772c-4e6c-9eaa-7eff85bb1900" />
<img width="819" height="666" alt="image" src="https://github.com/user-attachments/assets/e0789cd9-535c-40b5-b3d3-73f5ffd0bafd" />
<img width="1844" height="107" alt="goexec" src="https://github.com/user-attachments/assets/d63cc91b-cab5-471b-9364-ede8c629c7a9" />
