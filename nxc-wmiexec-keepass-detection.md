...
**Recommended prior reading:** [Vector 2 writeup](https://github.com/osherjacobs/AD-Lab-Research/blob/main/nxc-wmiexec-detection-gap.md) — same evasion chain, extended with post-exploitation credential access.
